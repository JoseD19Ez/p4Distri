...
public class Servidor2 {
    private static final int PUERTO_CLIENTES = 1025;
    private static final int PUERTO_SERVIDORES = 3090;
    ...
    public static void main(String[] args) {
        System.out.println("Servidor B iniciado en puerto " + PUERTO_SERVIDORES);
    ...
    private static void conectarAServidores(String host, int puerto) {
        try {
            ...
            new ManejadorServidor(socket).start(); // Para escuchar respuestas también
    ...
    private static class ManejadorServidor extends Thread {
        ...
        public void run() {
            try (
                ...
                otrosServidores.add(salida); // 🔧 Importante para permitir responder al servidor que se conectó
                String mensaje;
                while ((mensaje = entrada.readLine()) != null) {
