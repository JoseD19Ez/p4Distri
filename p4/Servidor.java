...
public class Servidor {
    private static final int PUERTO_CLIENTES = 1024;
    private static final int PUERTO_SERVIDORES = 3088;
    ...
    public static void main(String[] args) {
        System.out.println("Servidor A iniciado en puerto " + PUERTO_SERVIDORES);
